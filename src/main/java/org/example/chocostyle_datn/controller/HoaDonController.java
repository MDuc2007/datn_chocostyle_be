...
public class HoaDonController {
    ...
    // URL: POST /api/hoa-don/tai-quay/tao-moi?idNhanVien=1
    ...
    // API Cập nhật hóa đơn nháp (Xác nhận đặt hàng tại quầy)
    // URL: PUT /api/hoa-don/tai-quay/xac-nhan/{id}
    ...
    public ResponseEntity<?> xoaHoaDonTaiQuay(@PathVariable("id") Integer id) {
        try {
            hoaDonService.xoaHoaDonTaiQuay(id);
            return ResponseEntity.ok().body(Map.of("message", "Đã xóa hóa đơn thành công"));
        } catch (Exception e) {
